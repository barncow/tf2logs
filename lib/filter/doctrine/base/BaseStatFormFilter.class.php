...
abstract class BaseStatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'headshots'               => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'backstabs'               => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'flag_defends'            => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'flag_captures'           => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'headshots'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'backstabs'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'flag_defends'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'flag_captures'           => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
