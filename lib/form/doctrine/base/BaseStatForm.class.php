...
abstract class BaseStatForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'headshots'               => new sfWidgetFormInputText(),
      'backstabs'               => new sfWidgetFormInputText(),
      'capture_points_blocked'  => new sfWidgetFormInputText(),
      'capture_points_captured' => new sfWidgetFormInputText(),
      'flag_defends'            => new sfWidgetFormInputText(),
      'flag_captures'           => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'headshots'               => new sfValidatorInteger(array('required' => false)),
      'backstabs'               => new sfValidatorInteger(array('required' => false)),
      ...
      'flag_defends'            => new sfValidatorInteger(array('required' => false)),
      'flag_captures'           => new sfValidatorInteger(array('required' => false)),
