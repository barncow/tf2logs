...
module.exports = function(mongoose, conf) {
  ...
  /**
    ...
    @param name String to name the log with.
    @param callback function to call after data is updated. Will have err and the resulting log object passed to callback.
  */
  LogSchema.static('createLog', function(log, name, callback) {
      var logModel = new this(); //create a new model instance from a Schema instance (this)
      logModel.log = log;
      logModel.name = name; //actual filename
