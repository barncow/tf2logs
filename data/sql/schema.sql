...
CREATE TABLE player (id BIGINT, steamid VARCHAR(30) NOT NULL, credential VARCHAR(10) DEFAULT 'user' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
...
CREATE TABLE weapon (id BIGINT AUTO_INCREMENT, key_name VARCHAR(20) NOT NULL, name VARCHAR(30), role_id BIGINT, INDEX role_id_idx (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
