CREATE TABLE log (id BIGINT AUTO_INCREMENT, name VARCHAR(100) NOT NULL, redscore INT DEFAULT 0 NOT NULL, bluescore INT DEFAULT 0 NOT NULL, error_log_name VARCHAR(50), error_exception TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
...
CREATE TABLE role_stat (role_id BIGINT, stat_id BIGINT, PRIMARY KEY(role_id, stat_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
