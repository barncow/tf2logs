...
<li>
  The Log Page
  <ul>
    <li><a href="#logviewer">What is the Log Viewer?</a></li>
    <li><a href="#logstatstable">What is the Log Stats Table?</a></li>
    <li><a href="#healspreadtable">What is the Heal Spread Table?</a></li>
    <li><a href="#mediccomparisontable">What is the Medic Comparison Table?</a></li>
