...
$url = url_for("@server_verify?slug=".$server->getSlug());
$s = <<<EOD
<p>Now, let's go through and update your server configuration, and verify ownership of the server (and that everything works). Follow the next steps carefully to get started:</p>
<ol>
