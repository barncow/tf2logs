...
var xImg=Math.floor((coordinate.x-this.minX)/this.getCellWidth());var yImg=Math.floor((coordinate.y-this.minY)/this.getCellHeight());if(this.mirrorY){yImg=this.imgHeight-yImg;}
